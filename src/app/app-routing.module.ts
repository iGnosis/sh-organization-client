  ...
  },
  {
    ...
    children: [
      { path: "dashboard", component: DashboardComponent },
      {
        ...
        //   },
        // ],
        // loadChildren: () => import('./pages/home/patients/patient.module').then((m) => m.PatientsModule),
      },
...
export const ArrayOfComponents = [PatientsComponent, PatientDetailsComponent];
