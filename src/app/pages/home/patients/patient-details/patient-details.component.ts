...
export class PatientDetailsComponent implements OnInit, OnDestroy {
  ...
  async fetchSessions() {
    ...
    const firstName = patient.patient_by_pk.firstName.value;

    if (nickname) {
      this.breadcrumbService.set('@patientName', nickname);
      this.patientIdentifier = nickname;
      console.log('setting breadcrumbService.patientName to nickname ' + nickname);
    } else if (firstName) {
      this.breadcrumbService.set('@patientName', firstName);
      this.patientIdentifier = firstName;
      console.log('setting breadcrumbService.patientName to firstName ' + firstName);
    }
  }
